...
| 404 | No `app/not-found.tsx`; nonexistent route returns 404 through framework fallback. VERIFIED LIVE — LUMORA navigation, footer, title, and home links remain available around the default message. | MINOR |
